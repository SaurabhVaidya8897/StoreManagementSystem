...
import com.example.home.service.UserRegistrationService;
...
public class UserRegistrationController {
		...
		@GetMapping("/getalluser") // display all user
		...
		@GetMapping("/getuser/{userId}")  //display user by id
		...
		@DeleteMapping("/deleteuser/{userId}")   //delete by Id 
